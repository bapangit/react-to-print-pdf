...
import CreateCreditNote from "Components/Modules/CreditNote/CreateCreditNote/CreateCreditNote";
import BizClass from "./CreditNote.module.scss";
...
function CreditNote() {
  ...
  return (
    <>
      {openCreateInvoiceModal && <CreateCreditNote {...props} />}
