...
import CreateDebitNote from "Components/Modules/DebitNote/CreateDebitNote/CreateDebitNote";
import BizClass from "./DebitNote.module.scss";
...
function DebitNote() {
  ...
  return (
    <>
      {openCreateInvoiceModal && <CreateDebitNote {...props} />}
